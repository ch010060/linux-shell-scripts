...
def process_command():        
    ...
    parser.add_argument('-r', "--RECUR", action='store_true', help='recursive processing')
    parser.add_argument('-i', "--PATH", type=dir_path, required=True, help='absolute path for processing')
